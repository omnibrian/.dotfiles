;;; terraform.el --- Major mode for terraform files -*- lexical-binding: t -*-

;; provides terraform-mode as a major-mode for terraform files.

;; To automatically run `terraform fmt` on save:
...
(defgroup terraform nil
  "Major mode for Terraform files."
  :group 'languages)

(defcustom terraform-indent-level 2
  "The tab width for indentation."
  :type 'integer)
