...
(defcustom jsonnet-format-on-save nil
...
(define-derived-mode jsonnet-mode prog-mode "Jsonnet"
  ...
  (when jsonnet-format-on-save
    (jsonnet-format-on-save-mode 1))
  (if jsonnet-use-smie
      (progn
...
(define-minor-mode jsonnet-format-on-save-mode
  "Run jsonnet-reformat-buffer before saving current buffer."
  :lighter ""
  (if jsonnet-format-on-save-mode
